...
function getOptionTone({ selected, correct, wrong, answered }) {
  if (correct) {
    return 'border-[rgba(20,158,97,0.22)] bg-[rgba(20,158,97,0.10)] text-[var(--success)]'
  }
  if (wrong) {
    return 'border-[rgba(220,38,38,0.24)] bg-[rgba(220,38,38,0.08)] text-[var(--error)]'
  }
  if (selected) {
    return 'border-[rgba(87,65,216,0.22)] bg-[rgba(87,65,216,0.06)] text-[var(--app-ink-high)]'
  }
  if (answered) {
    return 'border-[var(--app-paper-border)] bg-[var(--app-paper-bg)] text-[var(--app-ink-low)]'
  }
  return 'border-[var(--app-paper-border)] bg-[var(--app-paper-bg)] text-[var(--app-ink-high)] hover:bg-[var(--app-paper-muted-bg)] hover:border-[var(--app-soft-border)]'
}
    ...
    return (
      <div className="max-w-6xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
          <section className="bg-[var(--app-paper-bg)] border border-[var(--app-paper-border)] rounded-[2rem] shadow-[0_4px_24px_rgba(0,0,0,0.03)] p-5 md:p-8 lg:p-10">
            <Link to={backLink} className="inline-flex items-center gap-2 text-[12px] font-medium text-[var(--app-ink-mid)] transition-colors hover:text-[var(--app-ink-high)]">
              <ArrowLeft size={14} />
              <span>{t('week.back')}</span>
            </Link>

            <div className="mt-6 grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px]">
              <div className="bg-[var(--app-paper-bg)] border border-[var(--app-paper-border)] rounded-[1.5rem] shadow-[0_4px_24px_rgba(0,0,0,0.03)] p-6 md:p-8 lg:p-10">
                ...
                <p className="mt-6 text-[11px] uppercase tracking-[0.22em] text-[var(--app-ink-low)]">
                  {isArticle ? t('quiz.articleQuiz') : t('quiz.weeklyTest')}
                </p>
                <h1 className="mt-3 max-w-3xl text-[28px] md:text-[36px] font-[800] tracking-[-0.05em] leading-tight text-[var(--app-ink-high)]">
                  {quizTitle}
                </h1>
                <p className="mt-4 max-w-3xl text-[14px] md:text-[15px] leading-relaxed text-[var(--app-ink-mid)]">
                  {pick(
                    lang,
                    isArticle
                ...
                <div className="mt-8 grid gap-4 border-t border-[var(--app-paper-border)] pt-5 md:grid-cols-2">
                  <div>
                    <p className="text-[11px] uppercase tracking-[0.18em] text-[var(--app-ink-low)]">{pick(lang, '열리는 것', 'Unlocks')}</p>
                  ...
                  <div>
                    <p className="text-[11px] uppercase tracking-[0.18em] text-[var(--app-ink-low)]">{pick(lang, '응시 방식', 'Attempt mode')}</p>
                    <p className="mt-2 text-[15px] font-[700] text-[var(--app-ink-high)]">{pick(lang, '횟수 제한 없음', 'Unlimited retries')}</p>
                    <p className="mt-1 text-[12px] leading-relaxed text-[var(--app-ink-mid)]">
                ...
                <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                  ...
                  <Link to={backLink} className="inline-flex items-center justify-center gap-2 rounded-[12px] bg-[var(--app-light-btn-bg)] text-[var(--app-ink-high)] font-semibold border border-[var(--app-paper-border)] transition-colors hover:bg-[var(--app-light-btn-hover-bg)] px-8 py-3 text-[14px]">
                    {t('week.back')}
                  </Link>
                </div>
              </div>
              ...
              <aside className="space-y-4 xl:sticky xl:top-24 xl:self-start">
                <div className="bg-[var(--app-paper-muted-bg)] border border-[var(--app-paper-border)] rounded-[1.5rem] p-5">
                  <p className="text-[11px] uppercase tracking-[0.18em] text-[var(--app-ink-low)]">{pick(lang, '응시 정보', 'Attempt summary')}</p>
                  <div className="mt-4 space-y-4">
                    <div>
                      <p className="text-[11px] uppercase tracking-[0.16em] text-[var(--app-ink-low)]">{pick(lang, '통과 기준', 'Pass threshold')}</p>
                      <p className="mt-1 text-[24px] font-[800] tabular-nums text-[var(--app-ink-high)]">{passThreshold}/{total}</p>
                    </div>
                    <div className="border-t border-[var(--app-paper-border)] pt-4">
                      <p className="text-[11px] uppercase tracking-[0.16em] text-[var(--app-ink-low)]">{t('quiz.attempts')}</p>
                      <p className="mt-1 text-[20px] font-[800] tabular-nums text-[var(--app-ink-high)]">{status.attempts}</p>
                    </div>
                    <div className="border-t border-[var(--app-paper-border)] pt-4">
                      <p className="text-[11px] uppercase tracking-[0.16em] text-[var(--app-ink-low)]">{t('quiz.bestScore')}</p>
                      <p className="mt-1 text-[20px] font-[800] tabular-nums text-[var(--app-ink-high)]">
                        {status.attempts > 0 ? `${status.bestScore}/${status.total}` : pick(lang, '기록 없음', 'No record')}
                      </p>
                    </div>
                    <div className="border-t border-[var(--app-paper-border)] pt-4">
                      <p className="text-[11px] uppercase tracking-[0.16em] text-[var(--app-ink-low)]">{t('quiz.passed')}</p>
                      <p className="mt-1 text-[13px] font-[700] text-[var(--app-ink-high)]">
        ...
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
          <section className="bg-[var(--app-paper-bg)] border border-[var(--app-paper-border)] rounded-[2rem] shadow-[0_4px_24px_rgba(0,0,0,0.03)] p-5 md:p-8 lg:p-10">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-4 text-[12px] text-[var(--app-ink-mid)]">
            ...
            <div className="mt-6 grid gap-6 xl:grid-cols-[minmax(0,1fr)_280px]">
              <div className="bg-[var(--app-paper-bg)] border border-[var(--app-paper-border)] rounded-[1.5rem] shadow-[0_4px_24px_rgba(0,0,0,0.03)] p-6 md:p-8 lg:p-10">
                <p className="text-[11px] uppercase tracking-[0.2em] text-[var(--app-ink-low)]">
                  {isArticle ? t('quiz.articleQuiz') : t('quiz.weeklyTest')}
                </p>
                <h1 className="mt-2 max-w-3xl text-[24px] md:text-[32px] font-[800] tracking-[-0.05em] leading-tight text-[var(--app-ink-high)]">{quizTitle}</h1>
                ...
                <div className="mt-4 flex flex-wrap items-center gap-3 text-[12px] text-[var(--app-ink-mid)]">
                ...
                <AnimatePresence mode="wait">
                  <motion.div
                    ...
                    className="mt-8"
                  >
                    <h2 className="text-[24px] md:text-[30px] font-[800] tracking-[-0.04em] leading-snug text-[var(--app-ink-high)]">
                              ...
                              correct
                                ...
                                : wrong
                                  ...
                                  : selected
                                    ...
                                    : 'border-[var(--app-paper-border)] bg-[var(--app-paper-muted-bg)] text-[var(--app-ink-mid)]'
                            }`}>
              ...
              <aside className="xl:sticky xl:top-24 xl:self-start">
                <div className="bg-[var(--app-paper-muted-bg)] border border-[var(--app-paper-border)] rounded-[1.5rem] p-5">
                  <p className="text-[11px] uppercase tracking-[0.18em] text-[var(--app-ink-low)]">{pick(lang, '풀이 정보', 'Session info')}</p>
                  <div className="mt-4 space-y-4">
                    <div>
                      <p className="text-[11px] uppercase tracking-[0.16em] text-[var(--app-ink-low)]">{pick(lang, '현재 진행', 'Current progress')}</p>
                      <p className="mt-1 text-[24px] font-[800] tabular-nums text-[var(--app-ink-high)]">{currentIdx + 1}/{questions.length}</p>
                    </div>
                    <div className="border-t border-[var(--app-paper-border)] pt-4">
                      <p className="text-[11px] uppercase tracking-[0.16em] text-[var(--app-ink-low)]">{pick(lang, '통과 기준', 'Pass threshold')}</p>
                      <p className="mt-1 text-[20px] font-[800] tabular-nums text-[var(--app-ink-high)]">{passThreshold}/{total}</p>
                    </div>
                    <div className="border-t border-[var(--app-paper-border)] pt-4">
                      <p className="text-[11px] uppercase tracking-[0.16em] text-[var(--app-ink-low)]">{t('quiz.bestScore')}</p>
                      <p className="mt-1 text-[20px] font-[800] tabular-nums text-[var(--app-ink-high)]">
                    ...
                    <div className="border-t border-[var(--app-paper-border)] pt-4">
                      <p className="text-[12px] leading-relaxed text-[var(--app-ink-mid)]">
                        {pick(
                          lang,
          ...
          <section className="bg-[var(--app-paper-bg)] border border-[var(--app-paper-border)] rounded-[2rem] shadow-[0_4px_24px_rgba(0,0,0,0.03)] p-5 md:p-8 lg:p-10">
            <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_300px]">
              <div className="bg-[var(--app-paper-bg)] border border-[var(--app-paper-border)] rounded-[1.5rem] shadow-[0_4px_24px_rgba(0,0,0,0.03)] p-6 md:p-8 lg:p-10">
                ...
                >
                  {passed ? <Trophy size={30} className="text-[var(--success)]" /> : <RotateCcw size={30} className="text-[var(--error)]" />}
                </motion.div>

                <h2 className={`mt-6 text-[32px] font-[800] tracking-[-0.05em] ${passed ? 'text-[var(--success)]' : 'text-[var(--error)]'}`}>
                  {passed ? t('quiz.passed') : t('quiz.failed')}
                </h2>
                <p className="mt-2 text-[14px] text-[var(--app-ink-mid)]">{quizTitle}</p>

                <div className="mt-8 border-t border-[var(--app-paper-border)] pt-5">
                  <div className="flex items-center justify-between">
                    <span className="text-[12px] uppercase tracking-[0.18em] text-[var(--app-ink-low)]">{t('quiz.score')}</span>
                    <span className={`text-[30px] font-[800] tabular-nums ${passed ? 'text-[var(--success)]' : 'text-[var(--error)]'}`}>
                      {score}/{total}
                    </span>
                  </div>
                ...
                {submitError && (
                  <p className="mt-5 text-[12px] leading-relaxed text-[var(--app-ink-mid)]">
                    {submitError}
                  </p>
                )}
                ...
                <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                  ...
                  <Link to={passed ? successLink : backLink} className="inline-flex items-center justify-center gap-2 rounded-[12px] bg-[var(--app-light-btn-bg)] text-[var(--app-ink-high)] font-semibold border border-[var(--app-paper-border)] transition-colors hover:bg-[var(--app-light-btn-hover-bg)] px-6 py-3 text-[13px]">
                    {passed ? successLabel : t('week.back')}
                  </Link>
                  {passed && (
                    <button type="button" onClick={handleStart} className="inline-flex items-center justify-center gap-2 rounded-[12px] bg-[var(--app-light-btn-bg)] text-[var(--app-ink-high)] font-semibold border border-[var(--app-paper-border)] transition-colors hover:bg-[var(--app-light-btn-hover-bg)] px-6 py-3 text-[13px]">
                      <RotateCcw size={14} />
                      {t('quiz.retry')}
                    </button>
                  )}
              ...
              <aside className="space-y-4 xl:sticky xl:top-24 xl:self-start">
                <div className="bg-[var(--app-paper-muted-bg)] border border-[var(--app-paper-border)] rounded-[1.5rem] p-5">
                  <p className="text-[11px] uppercase tracking-[0.18em] text-[var(--app-ink-low)]">{pick(lang, '결과 요약', 'Result summary')}</p>
                  <div className="mt-4 space-y-4">
                    <div>
                      <p className="text-[11px] uppercase tracking-[0.16em] text-[var(--app-ink-low)]">{t('quiz.passThreshold')}</p>
                      <p className="mt-1 text-[20px] font-[800] tabular-nums text-[var(--app-ink-high)]">{passThreshold}/{total}</p>
                    </div>
                    <div className="border-t border-[var(--app-paper-border)] pt-4">
                      <p className="text-[11px] uppercase tracking-[0.16em] text-[var(--app-ink-low)]">{pick(lang, '소요 시간', 'Elapsed')}</p>
                      <p className="mt-1 text-[20px] font-[800] tabular-nums text-[var(--app-ink-high)]">{formatTime(elapsed)}</p>
                    </div>
                    {!passed && (
                      <div className="border-t border-[var(--app-paper-border)] pt-4">
                        <div className="inline-flex items-center gap-2 rounded-full border border-[var(--app-paper-border)] px-4 py-2 text-[12px] text-[var(--app-ink-mid)]">
                          <Lock size={13} />
