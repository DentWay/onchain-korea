...
export default function HeroPathPreview() {
  ...
  return (
    <section className="relative bg-[var(--surface-0)] px-6 pb-24 pt-10 md:pt-14">
          ...
          <div className="relative z-10">
            <div className="border-t border-[rgba(255,255,255,0.10)] pt-6">
              <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
                <div>
                  <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[var(--text-low)]">
                    {pick(lang, '스크롤 뒤에 이어질 경로', 'What opens next')}
                  </p>
                  <h2 className="mt-2 text-[28px] font-semibold tracking-[-0.04em] text-[var(--text-high)] md:text-[36px]">
            ...
            <div className="mt-8 grid gap-0 lg:grid-cols-4 lg:gap-8">
              {heroProof.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[rgba(59,130,246,0.10)] text-[#79AFFF]">
                      <Icon size={18} />
                    </div>
                    <div>
                      <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[var(--text-low)]">
                        {item.badge}
                      </p>
                      <h3 className="mt-2 text-[19px] font-semibold leading-snug text-[var(--text-high)]">
                        {item.title}
                      </h3>
                      <p className="mt-2 max-w-2xl text-[14px] leading-relaxed text-[var(--text-mid)]">
                        {item.desc}
                      </p>
                    </div>
                    <div className="text-[12px] font-semibold text-[#79AFFF] lg:pt-3">
