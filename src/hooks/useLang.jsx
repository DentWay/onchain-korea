...
const translations = {
  ...
  'week.completePrevLesson': { ko: '이전 주 테스트를 먼저 통과해야 합니다', en: 'Pass the previous weekly test first' },
  'week.completeLessonsForActions': { ko: '이번 주 아티클 퀴즈를 모두 통과하면 열립니다', en: 'Pass all article quizzes to unlock' },
  'week.completeActionForHidden': { ko: '실습 1개를 완료하면 열립니다', en: 'Complete at least 1 action to unlock' },

  // Lesson Detail
  'lesson.preparing': { ko: '콘텐츠 준비 중', en: 'Korean content coming soon' },
  'lesson.preparingDesc': { ko: '이 아티클의 한국어 본문을 다듬고 있습니다.\n지금은 Greed Academy 원문으로 먼저 볼 수 있습니다.', en: 'Korean translation of this lesson will be available soon.\nPlease refer to the original Greed Academy article in the meantime.' },
  ...
  'lesson.passQuizToUnlockNext': { ko: '이 퀴즈를 통과하면 다음 아티클이 열립니다', en: 'Pass this quiz to unlock the next article' },
  ...
  'hidden.desc': { ko: '주차별로 꼭 알아야 할 시장 맥락을 모아둔 공간입니다. 실습과 함께 읽으면 흐름이 더 잘 보입니다.', en: 'Weekly hot Web3 topics in Korea. Discuss in the forum and try related on-chain actions.' },
  ...
  'cert.notYetDesc': { ko: '아래 조건을 채우면 수료증이 열립니다', en: 'Meet the requirements below to earn your Proof of Attendance' },
  ...
  'landing.roadmapDesc': { ko: '먼저 Week 1-4에서 블록체인 기본기를 만들고, 주간 테스트를 통과하면 Week 5-8 심화 트랙이 열립니다.', en: 'Weeks 1-4 build the foundation. Pass the weekly tests and Weeks 5-8 unlock as the advanced track.' },
  ...
  'auth.oauthGenericIssue': { ko: '소셜 로그인 처리 중 오류가 발생했습니다. 잠시 후 다시 시도해주세요.', en: 'There was an error during social login. Please try again shortly.' },
  'auth.oauthRedirectIssue': { ko: '로그인 리디렉션 설정이 맞지 않습니다. 관리자에게 URL 설정 확인이 필요합니다.', en: 'The login redirect settings do not match. An admin needs to verify the configured URLs.' },
  ...
  'quiz.failed': { ko: '한 번 더 풀어보세요', en: 'Try Again' },
  ...
  'quiz.passAllArticles': { ko: '아티클 퀴즈를 모두 통과하면 열립니다', en: 'Pass all lesson quizzes to unlock' },
